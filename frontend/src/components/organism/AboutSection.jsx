            ...
            <div className="flex flex-col gap-4 md768:gap-10 md768:flex-1 relative">
                <div className="flex flex-col gap-2 md768:gap-4">
                    ...
                    <h5 className="text-[clamp(18px,5.5vw,37px)]  text-transparent text-gradient-green">
                        Imprima un sello verde a su ambiente laboral para transformarlo.
                    </h5>

                    <p className="text-[clamp(14.5px,2.5vw,29px)] font-extralight text-dark-gray">
                        Reduzca el impacto ambiental en su empresa u organización con propuestas como optimizar el uso de energía, gestionar residuos, y fomentar medidas sostenibles en su equipo.
                    </p>
                </div>
                <p className="text-[clamp(13px,2.5vw,18px)] font-light text-green-dark">
                    Implementar acciones para reducir la huella ecológica como hacer un uso más eficiente de la energía, o una correcta gestión de los residuos, mejora la eficiencia, reduce costos y motiva a su personal, brindando una imagen positiva y consciente.
                </p>
                <p className="text-[clamp(13px,2.5vw,18px)] font-light text-green-dark">
                    La calculadora de huella de carbono de Co2llector permite identificar fácilmente oportunidades de mejora, a fin de promover buenas prácticas laborales, y posicionar a su empresa u organización como referente en responsabilidad ambiental y compromiso con un futuro más verde
                </p>
