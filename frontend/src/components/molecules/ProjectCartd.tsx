...
const ProjectCartd = ({
  ...
  return (
    <div className="relative min-w-[240px] h-[250] md768:min-w-[308px] md768:h-[400px] xl1440:min-w-[416px] xl1440:h-[440px] rounded-4xl md768:rounded-[42.5px] xl1440:rounded-[50px] overflow-hidden shadow-xl bg-black/20 px-[25.5px] ">
      ...
      {/* Etiqueta superior */}
      <div className="absolute top-6 left-6  hidden text-white text-xs  px-2.5 py-1.5 rounded-[50px] backdrop-blur-3xl bg-black/40">
        PAPER
      </div>

      {/* Título en el centro */}
      <div className="absolute hidden inset-0  items-center justify-center px-4 text-center">
      ...
      {/* Footer degradado */}
      <div className="absolute hidden bottom-0 left-0 w-full bg-gradient-to-t from-black/70 to-transparent px-6 py-6  gap-1 justify-between backdrop-blur-2xl bg-black/40">
