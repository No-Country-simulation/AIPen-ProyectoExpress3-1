    ...
    <div className="py-[50px]">
      ...
      <div className="flex justify-between">
        ...
        <div className="relative size-[52px] bg-amber-400 rounded-full flex justify-center items-center">
          <Image src={iconArrow} alt="icon Arrow" width={16.5} height={16.5} className="hover:rotate-45 transition-all duration-600" />
        </div>
      </div>
      <p className="text-[clamp(0.90rem,2.5vw,1.125rem)]">{description}</p>
    </div>
  );
};
